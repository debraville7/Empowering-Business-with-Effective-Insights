...
This project demonstrate my skill as an analytics consultant for a high-performing online retailer, I built a strategic dashboard in Power BI utilizing SQL and DAX to deliver high-impact insights for the CEO and CMO. The project blends operational and marketing analytics to isolate the core revenue drivers behind the store's success, providing leadership with a clear roadmap for next year's expansion.
...
## 📌 Executive Summary
* **The Goal:** The CMO wants to target the higher revenue generating customers and ensure that they remain satisfied with their products.
* **The Impact:** The data shows that there is not much of a difference between the purchases made by the top 10 customers. The highest revenue generating customer only purchased 17% more than the 2nd highest.
* **Key Finding:** This shows that the business is not relying only on a few customers to generate the revenue.
